...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'phone'=>'string|nullable|unique:clientes,phone,'.$this->route('cliente')->id.'|min:7|max:10', 
            'email'=>'string|nullable|unique:clientes,email,'.$this->route('cliente')->id.'|max:250|email:rfc,dns',
        ];
    }
